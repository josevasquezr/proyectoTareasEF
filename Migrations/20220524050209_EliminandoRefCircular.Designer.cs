...
namespace proyectoTareasEF.Migrations
{
    ...
    [Migration("20220524050209_EliminandoRefCircular")]
    partial class EliminandoRefCircular
    {
            ...
            modelBuilder.Entity("proyectoTareasEF.Models.Tarea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = new Guid("c88ff4bc-6a99-48ee-95f5-848fc205ac23"),
                            FechaCreacion = new DateTime(2022, 5, 23, 23, 2, 8, 826, DateTimeKind.Local).AddTicks(1075),
                            PrioridadTarea = 1,
                            Recordatorio = false,
                        ...
                        new
                        {
                            ...
                            CategoriaId = new Guid("c88ff4bc-6a99-48ee-95f5-848fc205ac24"),
                            FechaCreacion = new DateTime(2022, 5, 23, 23, 2, 8, 826, DateTimeKind.Local).AddTicks(1112),
                            PrioridadTarea = 0,
                            Recordatorio = false,
                        ...
                        new
                        {
                            ...
                            CategoriaId = new Guid("c88ff4bc-6a99-48ee-95f5-848fc205ac25"),
                            FechaCreacion = new DateTime(2022, 5, 23, 23, 2, 8, 826, DateTimeKind.Local).AddTicks(1117),
                        ...
                        new
                        {
                            ...
                            CategoriaId = new Guid("c88ff4bc-6a99-48ee-95f5-848fc205ac26"),
                            FechaCreacion = new DateTime(2022, 5, 23, 23, 2, 8, 826, DateTimeKind.Local).AddTicks(1353),
